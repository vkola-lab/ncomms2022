...
def shap_region_scores_to_csv(data_dir, task, dataname, layername):
    ...
    f = open(dataname + '_shap_{}_region_scores_{}.csv'.format(task, layername), 'w')
...
if __name__ == "__main__":
    shap_region_scores_to_csv('/data_2/sq/Radiologist/', 'ADD', 'Radio', 'block2conv')
    shap_region_scores_to_csv('/data_2/sq/Radiologist/', 'COG', 'Radio', 'block2conv')
